      ...
      <div className="container-pad grid gap-10 py-14 md:grid-cols-3">
        ...
        <div className="space-y-3 text-sm text-slate-300">
          ...
          <p className="flex gap-2">
            <Phone size={16} /> +91-9229054731 || +91-9142009580 (WHATSAPP)
          </p>
          <p className="flex gap-2">
            <Mail size={16} /> svninfrasolarservices@gmail.com
          </p>
          <p className="flex gap-2">
        ...
        <div className="space-y-3">
          ...
          <Link
            className="block text-slate-300 hover:text-white"
            href="https://www.linkedin.com/in/sushant-sagar-723b65338/"
          >
            Developed By : SUSHANT SAGAR
          </Link>
        </div>
      </div>
